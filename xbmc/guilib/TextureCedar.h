...
/*    CGLTexture                                                       */
/************************************************************************/
class CCedarTexture : public CGLTexture
{
public:
  CCedarTexture(unsigned int width = 0, unsigned int height = 0, unsigned int format = XB_FMT_A8R8G8B8);
  virtual ~CCedarTexture();
  void LoadToGPU();
