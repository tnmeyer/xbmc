...
const std::string CSettings::SETTING_VIDEOPLAYER_USEVDPAUH264 = "videoplayer.usevdpauh264";
const std::string CSettings::SETTING_VIDEOPLAYER_USEVDPAUH265 = "videoplayer.usevdpauh265";
