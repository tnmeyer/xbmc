...
class CRendererSunxi : public CLinuxRendererGLES
{
public:
  CRendererSunxi();
  virtual ~CRendererSunxi();
...
protected:
  ...
  virtual void RenderDisp2Texture(int index, int field);
  ...
  std::deque<CCedarXBuffer*> m_bufHistory;
  static void Release(CCedarXBuffer *&t) { if (t) t->Release(); }
};
